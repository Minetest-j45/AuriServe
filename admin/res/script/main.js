...
var ___CSS_LOADER_EXPORT___ = _node_modules_css_loader_dist_runtime_api_js__WEBPACK_IMPORTED_MODULE_0___default()(true);
// Module
___CSS_LOADER_EXPORT___.push([module.i, ".MediaItem {\n  position: relative;\n  background-color: transparent;\n  cursor: pointer;\n  border: none;\n  outline: 0;\n  user-select: none;\n  border-radius: 4px;\n  text-decoration: none;\n  border: 1px solid transparent;\n  background: rgba(159, 179, 200, 0.15); }\n  .MediaItem::after {\n    content: \" \";\n    display: block;\n    position: absolute;\n    user-select: none;\n    pointer-events: none;\n    top: -1px;\n    left: -1px;\n    right: -1px;\n    bottom: -1px;\n    margin: 4px;\n    transform: scale(0.87);\n    border-radius: inherit;\n    background: rgba(130, 154, 177, 0);\n    transition: background 0.3s cubic-bezier(0.1, 0.43, 0.43, 1.02), transform 0.5s cubic-bezier(0.1, 0.43, 0.43, 1.02) 0.075s, margin 0.5s cubic-bezier(0.1, 0.43, 0.43, 1.02); }\n  .MediaItem:not(:disabled):hover::after, .MediaItem:not(:disabled):focus::after {\n    margin: 0px;\n    transform: scale(1);\n    background: rgba(130, 154, 177, 0.15);\n    transition: background 0.15s cubic-bezier(0.1, 0.43, 0.43, 1.02), transform 0.15s cubic-bezier(0.1, 0.43, 0.43, 1.02), margin 0.15s cubic-bezier(0.1, 0.43, 0.43, 1.02); }\n  .MediaItem:not(:disabled):active {\n    transition: border 0.15s; }\n  .MediaItem:not(:disabled):focus {\n    border-color: #829ab1; }\n  .MediaItem:disabled {\n    cursor: auto;\n    opacity: 0.65;\n    color: #627d98; }\n\n.MediaItem {\n  background: transparent;\n  border-color: #d9e2ec;\n  box-sizing: content-box;\n  user-select: none;\n  padding: 8px;\n  height: 80px;\n  display: grid;\n  grid-template-columns: 80px 1fr;\n  grid-gap: 16px; }\n  .MediaItem > * {\n    box-sizing: border-box; }\n  .MediaItem.selected {\n    border-color: #54d1db;\n    background-color: rgba(135, 234, 242, 0.3); }\n    .MediaItem.selected:focus::after, .MediaItem.selected:hover::after {\n      background-color: rgba(135, 234, 242, 0.2); }\n    .MediaItem.selected .MediaIcon.Icon {\n      background-color: rgba(56, 190, 201, 0.3); }\n  .MediaItem .MediaItem-Description {\n    height: 100%;\n    overflow: auto;\n    text-align: left;\n    padding-top: 8px; }\n    .MediaItem .MediaItem-Description p {\n      margin-top: 0em;\n      margin-bottom: 0.3em;\n      overflow: hidden;\n      white-space: nowrap;\n      text-overflow: ellipsis; }\n    .MediaItem .MediaItem-Description p.MediaItem-Title {\n      font-size: 18px; }\n    .MediaItem .MediaItem-Description p.MediaItem-Author {\n      opacity: 0.8;\n      font-size: 14px; }\n    .MediaItem .MediaItem-Description p.MediaItem-Size {\n      opacity: 0.7;\n      font-size: 14px; }\n", "",{"version":3,"sources":["webpack://components/media/MediaItem.scss","webpack://partial/_Ext.scss","webpack://partial/_Vars.scss"],"names":[],"mappings":"AAGA;ECyEC,kBAAkB;EAClB,6BAA6B;EAC7B,eAAe;EACf,YAAY;EACZ,UAAU;EAEV,iBAAiB;EACjB,kBAAkB;EAClB,qBAAqB;EACrB,6BAA6B;EAC7B,qCAAiD,EAAA;EDnFlD;ICwFE,YAAY;IACZ,cAAc;IACd,kBAAkB;IAClB,iBAAiB;IACjB,oBAAoB;IAGpB,SAAS;IACT,UAAU;IACV,WAAW;IACX,YAAY;IAEZ,WAAW;IACX,sBAAsB;IAEtB,sBAAsB;IACtB,kCAA2C;IAE3C,2KArB0C,EAAA;EDrF5C;ICgHI,WAAW;IACX,mBAAmB;IACnB,qCAAiD;IAEjD,uKA/BwC,EAAA;EDrF5C;ICyHG,wBCpGW,EAAA;EFrBd;IC6HG,qBC5HkB,EAAA;EFDrB;ICkIE,YAAY;IACZ,aAAa;IACb,cClImB,EAAA;;AFFrB;EAEC,uBAAuB;EACvB,qBELoB;EFMpB,uBAAuB;EACvB,iBAAiB;EACjB,YAAY;EAGZ,YADQ;EAGR,aAAa;EACb,+BAA6B;EAC7B,cAAc,EAAA;EAbf;IAgBE,sBAAsB,EAAA;EAhBxB;IAoBE,qBERkB;IFSlB,0CAAkD,EAAA;IArBpD;MAwBG,0CAAkD,EAAA;IAxBrD;MA4BG,yCAAkD,EAAA;EA5BrD;IAiCE,YAAY;IACZ,cAAc;IACd,gBAAgB;IAChB,gBAAgB,EAAA;IApClB;MAuCG,eAAe;MACf,oBAAoB;MAEpB,gBAAgB;MAChB,mBAAmB;MACnB,uBAAuB,EAAA;IA5C1B;MAgDG,eAAe,EAAA;IAhDlB;MAoDG,YAAY;MACZ,eAAe,EAAA;IArDlB;MAyDG,YAAY;MACZ,eAAe,EAAA","sourcesContent":["@import \"../../partial/Vars\";\n@import \"../../partial/Ext\";\n\n.MediaItem {\n\t@extend %material_button;\n\tbackground: transparent;\n\tborder-color: $neutral-100;\n\tbox-sizing: content-box;\n\tuser-select: none;\n\tpadding: 8px;\n\n\t$h: 80px;\n\theight: $h;\n\n\tdisplay: grid;\n\tgrid-template-columns: $h 1fr;\n\tgrid-gap: 16px;\n\n\t& > * {\n\t\tbox-sizing: border-box;\n\t}\n\n\t&.selected {\n\t\tborder-color: $accent-400;\n\t\tbackground-color: transparentize($accent-300, 0.7);\n\n\t\t&:focus::after, &:hover::after {\n\t\t\tbackground-color: transparentize($accent-300, 0.8);\n\t\t}\n\n\t\t.MediaIcon.Icon {\n\t\t\tbackground-color: transparentize($accent-500, 0.7);\n\t\t}\n\t}\n\n\t.MediaItem-Description {\n\t\theight: 100%;\n\t\toverflow: auto;\n\t\ttext-align: left;\n\t\tpadding-top: 8px;\n\n\t\tp {\n\t\t\tmargin-top: 0em;\n\t\t\tmargin-bottom: 0.3em;\n\n\t\t\toverflow: hidden;\n\t\t\twhite-space: nowrap;\n\t\t\ttext-overflow: ellipsis;\n\t\t}\n\n\t\tp.MediaItem-Title {\n\t\t\tfont-size: 18px;\n\t\t}\n\n\t\tp.MediaItem-Author {\n\t\t\topacity: 0.8;\n\t\t\tfont-size: 14px;\n\t\t}\n\n\t\tp.MediaItem-Size {\n\t\t\topacity: 0.7;\n\t\t\tfont-size: 14px;\n\t\t}\n\t}\n}\n","@import \"Vars\";\n\n%card {\n\theight: min-content;\n\tborder-radius: 4px;\n\tpadding: 16px 24px;\n\n\tbackground-color: #fff;\n\tbox-shadow: 0px 2px 8px 0px transparentize($neutral-1000, 0.9);\n}\n\n%card_toolbar {\n\tdisplay: flex;\n\tflex-direction: row;\n\tjustify-content: space-between;\n\n\tbutton {\n\t\t@extend %material_icon_button;\n\t}\n\n\t.separator {\n\t\twidth: 24px;\n\t\tdisplay: inline-block;\n\t}\n\n\tdiv:first-of-type button {\n\t\tmargin-right: 8px;\n\t}\n\n\tdiv:last-of-type:not(:first-of-type) button {\n\t\tmargin-left: 8px;\n\t}\n}\n\n%center_wrap {\n\tdisplay: flex;\n\twidth: 100%;\n\theight: 100%;\n\tflex-direction: column;\n\tjustify-content: center;\n\talign-items: center;\n}\n\n%para_no_collapse {\n\t// Use Japanese fullwidth spaces\n\t// to prevent line collapsing.\n\t&::before, &::after { content: \"　\"; }\n}\n\n%material_border {\n\tborder-radius: 4px;\n\tborder-width: 1px;\n\tborder-style: solid;\n\tborder-color: $neutral-400;\n}\n\n%material_input {\n\t@extend %material_border;\n\tborder-color: $neutral-100;\n\toutline: 0;\n\n\t&:hover {\n\t\tborder-color: $neutral-200;\n\t}\n\n\t&:focus {\n\t\tborder-color: $neutral-400;\n\t}\n\n\t&::placeholder {\n\t\tfont-weight: 400;\n\t\tcolor: $neutral-400;\n\t}\n}\n\n%material_button {\n\tposition: relative;\n\tbackground-color: transparent;\n\tcursor: pointer;\n\tborder: none;\n\toutline: 0;\n\n\tuser-select: none;\n\tborder-radius: 4px;\n\ttext-decoration: none;\n\tborder: 1px solid transparent;\n\tbackground: transparentize($neutral-300, 1 - .15);\n\n\t$curve: cubic-bezier(0.1, 0.43, 0.43, 1.02);\n\n\t&::after {\n\t\tcontent: \" \";\n\t\tdisplay: block;\n\t\tposition: absolute;\n\t\tuser-select: none;\n\t\tpointer-events: none;\n\n\t\t// Compensate for 1px border.\n\t\ttop: -1px;\n\t\tleft: -1px;\n\t\tright: -1px;\n\t\tbottom: -1px;\n\n\t\tmargin: 4px;\n\t\ttransform: scale(0.87);\n\t\n\t\tborder-radius: inherit;\n\t\tbackground: transparentize($neutral-400, 1);\n\n\t\ttransition: background $t-med $curve, transform $t-slow $curve $t-ufast, margin $t-slow $curve;\n\t}\n\n\t&:not(:disabled) {\n\t\t&:hover, &:focus {\n\t\t\t&::after {\n\t\t\t\tmargin: 0px;\n\t\t\t\ttransform: scale(1);\n\t\t\t\tbackground: transparentize($neutral-400, 1 - .15);\n\n\t\t\t\ttransition: background $t-fast $curve, transform $t-fast $curve, margin $t-fast $curve;\n\t\t\t}\n\t\t}\n\n\t\t&:active {\n\t\t\ttransition: border $t-fast;\n\t\t}\n\n\t\t&:focus {\n\t\t\tborder-color: $neutral-400;\n\t\t}\n\t}\n\n\t&:disabled {\n\t\tcursor: auto;\n\t\topacity: 0.65;\n\t\tcolor: $neutral-500;\n\t}\n}\n\n%material_icon_button {\n\t@extend %material_button;\n\tdisplay: inline-block;\n\n\t// width: 48px;\n\theight: 48px;\n\n\tpadding: 8px;\n\tborder-radius: 24px;\n\n\timg {\n\t\twidth: 30px;\n\t\theight: 30px;\n\t\tpointer-events: none;\n\t\tvertical-align: middle;\n\t}\n\n\tspan {\n\t\tcolor: $neutral-700;\n\t\tvertical-align: middle;\n\t\tpadding-right: 8px;\n\t\tpadding-left: 8px;\n\t}\n}\n","$neutral-000: #f0f4f8;\n$neutral-100: #d9e2ec;\n$neutral-200: #bcccdc;\n$neutral-300: #9fb3c8;\n$neutral-400: #829ab1;\n$neutral-500: #627d98;\n$neutral-600: #486581;\n$neutral-700: #334e68;\n$neutral-800: #243b53;\n$neutral-900: #102a43;\n$neutral-1000:#081e38;\n\n$accent-100: #e0fcff;\n$accent-200: #bef8fd;\n$accent-300: #87eaf2;\n$accent-400: #54d1db;\n$accent-500: #38bec9;\n$accent-600: #2cb1bc;\n$accent-700: #14919b;\n$accent-800: #0e7c86;\n$accent-900: #0a6c74;\n$accent-1000:#044e54;\n\n$t-ufast: 0.075s;\n$t-fast: 0.15s;\n$t-med: 0.3s;\n$t-slow: 0.5s;\n\n$wrap-wide: 1400px;\n\n$m-wide: 1400px;\n$m-med: 1000px;\n$m-small: 600px;\n"],"sourceRoot":""}]);
// Exports
/* harmony default export */ __webpack_exports__["default"] = (___CSS_LOADER_EXPORT___);
...
/* harmony import */ var _MediaReplaceForm__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./MediaReplaceForm */ "./components/media/MediaReplaceForm.tsx");
/* harmony import */ var _MediaIcon__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./MediaIcon */ "./components/media/MediaIcon.tsx");
/* harmony import */ var _DimensionTransition__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../DimensionTransition */ "./components/DimensionTransition.tsx");
...
class MediaView extends preact__WEBPACK_IMPORTED_MODULE_0__["Component"] {
  ...
  render(props) {
    ...
    }, _common_util_Format__WEBPACK_IMPORTED_MODULE_5__["bytes"](props.item.size), " \u2022 Uploaded by ", props.item.uploadUser, " ", _common_util_Format__WEBPACK_IMPORTED_MODULE_5__["date"](props.item.uploadDate)), preact__WEBPACK_IMPORTED_MODULE_0__["h"]("h3", {
